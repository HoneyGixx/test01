...
(  "Название ингредиента" Character varying(100) NOT NULL,
  "Описание" Text)
WITH (  autovacuum_enabled=true)
;
ALTER TABLE "Ингредиенты" ADD CONSTRAINT "PK_Ингредиенты" PRIMARY KEY ("Название Ингредиенты");
-- Table Количество ингредиентов в рецептах
CREATE TABLE "Количество ингредиентов в рецептах"
(  "Значение" Real NOT NULL,
  "Название рецепта" Character varying(200) NOT NULL,  "Название ингредиента" Character varying(100) NOT NULL,
  "Название ЕИ" Character varying(50))
WITH (  autovacuum_enabled=true)
;
CREATE INDEX "IX_Relationship5" ON "Количество ингредиентов в рецептах" ("Название ЕИ");
ALTER TABLE "Количество ингредиентов в рецептах" ADD CONSTRAINT "PK_Количество ингредиентов в рецептах" PRIMARY KEY ("Название рецепта","Название ингредиента")
;
...
ALTER TABLE "Количество ингредиентов в рецептах"  ADD CONSTRAINT "рецепт-колв"
    FOREIGN KEY ("Название рецепта")    REFERENCES "Рецепты" ("Название рецепта")
      ON DELETE NO ACTION      ON UPDATE NO ACTION
;
ALTER TABLE "Количество ингредиентов в рецептах"  ADD CONSTRAINT "ингредиенты-колво"
    FOREIGN KEY ("Название ингредиента")    REFERENCES "Индигриенты" ("Название ингредиента")
      ON DELETE NO ACTION      ON UPDATE NO ACTION
;
